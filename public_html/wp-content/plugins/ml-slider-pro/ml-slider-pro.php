        ...
        protected function passes_requirements()
        {
            if (! (bool)($plugin = $this->has_metaslider_installed())) {
                ...
                return new WP_Error(
                    ...
                    sprintf(
                        __(
                            "The MetaSlider Pro Add-on Pack requires the MetaSlider plugin to be installed. You may download it by clicking <a href='%s'>here</a>.",
                            "ml-slider-pro"
                        ),
                        wp_nonce_url(
                            self_admin_url(
            ...
            if (! $this->has_metaslider_activated()) {
                ...
                return new WP_Error(
                    ...
                    sprintf(
                        __(
                            "The MetaSlider Pro Add-on Pack requires the MetaSlider plugin to be activated. You may activate it by clicking <a href='%s'>here</a>.",
                            "ml-slider-pro"
                        ),
                        $nonce
                    )
            ...
            if (! $this->has_metaslider_minimum_version()) {
                ...
                return new WP_Error(
                    ...
                    sprintf(
                        __(
                            "The MetaSlider Pro Add-on Pack requires the MetaSlider plugin (free version) to be at least version %s. You may update it by clicking <a href='%s'>here</a>.",
                            "ml-slider-pro"
                        ),
