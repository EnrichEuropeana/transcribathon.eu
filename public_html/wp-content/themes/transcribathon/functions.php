...
function load_admin_page($pageData)
{
	...
	if (is_admin()) {
		...
		//[page_title,   menu_title,  capability,       menu_slug,              callback,                    icon_url,                  position],
			...
			['Stories',   'Stories',   'manage_options', 'documents-admin-page', '_TCT_documents_admin_page', 'dashicons-media-document', 3],
...
function embedd_custom_javascripts_and_css() {
    ...
    if (!is_admin() && $GLOBALS['pagenow'] != 'wp-login.php') {
        ...
        wp_enqueue_style('foundation-style', get_stylesheet_directory_uri() .'/style.css', array(), $themeVersion);
        /* Bootstrap CSS */
        ...
        switch ($post->post_name) {
            ...
            case 'item':
                ...
                /* mapbox js and style*/
                wp_enqueue_script( 'mapbox-gl', 'https://api.mapbox.com/mapbox-gl-js/v2.14.1/mapbox-gl.js', null, null, true );
...
add_action('wp_enqueue_scripts', 'dequeue_parent_style', 11);
